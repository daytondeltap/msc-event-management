...
/* v31 production safe boot: storage sanitation, responsive recovery, auth/feature stability, branding. */
(() => {
  'use strict';
  ...
  [
    ...
    `features-v14.css?v=${BUILD}`,`features-v15.css?v=${BUILD}`,`features-v16.css?v=${BUILD}`,`features-v17.css?v=${BUILD}`,`features-v18.css?v=${BUILD}`,`features-v19.css?v=${BUILD}`,`features-v20.css?v=${BUILD}`,`features-v21.css?v=${BUILD}`,`features-v23.css?v=${BUILD}`,`features-v25.css?v=${BUILD}`,`features-v28-production.css?v=${BUILD}`,`features-v29-device.css?v=${BUILD}`,`features-v30-brand.css?v=${BUILD}`,`features-v31-stability.css?v=${BUILD}`
  ].forEach(addStyle);
  ...
  window.addEventListener('load',()=>{
    ...
    loadScript(`app-v28-production.js?v=${BUILD}`,'data-msc-production')
      ...
      .then(()=>loadScript(`app-v31-stability.js?v=${BUILD}`,'data-gem-v31-stability'))
      .then(()=>{window.MSC_BOOT_STATE={...(window.MSC_BOOT_STATE||{}),phase:'production-ready',safeMode:false,build:BUILD};});
  },{once:true});
})();
